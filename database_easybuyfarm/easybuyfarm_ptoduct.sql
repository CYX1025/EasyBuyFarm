...
--
-- Table structure for table `ptoduct`
--

DROP TABLE IF EXISTS `ptoduct`;
...
--
-- Dumping data for table `ptoduct`
--

LOCK TABLES `ptoduct` WRITE;
/*!40000 ALTER TABLE `ptoduct` DISABLE KEYS */;
/*!40000 ALTER TABLE `ptoduct` ENABLE KEYS */;
UNLOCK TABLES;
